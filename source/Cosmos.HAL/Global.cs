  ...
  public static class Global
  {
    ...
    public static bool InterruptsEnabled
    {
      get
      {
        ...
        {
            Cosmos.Core.Scheduler.CreateNewThread(entry);
        }

        //public static void AddThread(Core.Scheduler.ThreadData data)
        //{
        //    Cosmos.Core.Scheduler.AddThread(data);
        //}

        //public static void RemoveThread(Core.Scheduler.ThreadData data)
        //{
        //    Cosmos.Core.Scheduler.RemoveThread(data);
        //}
  }
}
